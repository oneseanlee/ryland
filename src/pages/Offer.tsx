...
/**
 * Fixed campaign deadline: Friday, September 18, 2026 at 11:59 PM Eastern Time (EDT, UTC-4).
 * 2026-09-18T23:59:00-04:00 === 2026-09-19T03:59:00Z
 * Every visitor sees the same real deadline — the counter reflects genuine time remaining.
 */
function getDeadline(): number {
  return new Date("2026-09-19T03:59:00Z").getTime();
}
...
const TimerBox = ({ value, label }: { value: string; label: string }) => (
  <div className="flex flex-col items-center">
    <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm flex items-center justify-center">
      <span className="text-lg sm:text-2xl font-semibold text-white tabular-nums font-[Manrope,sans-serif]">
        {value}
      </span>
    </div>
    <span className="mt-1 text-[9px] sm:text-[10px] uppercase tracking-widest text-blue-200">{label}</span>
  </div>
);
  ...
  return (
    <div className="min-h-screen bg-white antialiased text-slate-900 selection:bg-blue-500/30 selection:text-white">
      <PageMeta
        ...
        description="Choose your program — Funding Ready or Credit Work Needed. This limited-time offer ends Friday, September 18 at 11:59 PM EDT and includes flexible payment plans. Results vary and are not guaranteed."
        canonical="/offer"
        noindex
      />
      ...
      {/* Hero with countdown */}
      <section className="relative mx-4 sm:mx-6 lg:mx-auto mt-4 sm:mt-6 max-w-7xl pt-8 sm:pt-10 pb-10 px-4 sm:px-8 rounded-2xl border border-[#004E8C] overflow-hidden bg-gradient-to-br from-[#003A70] via-[#004E8C] to-[#0060A9]">
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tighter text-white font-[Manrope,sans-serif] leading-[1.02]">
              Choose Your Program
            </h1>
            <p className="text-sm sm:text-base text-blue-100 mt-3 max-w-2xl mx-auto leading-relaxed">
              Webinar special enrollment ends Friday, Sept 18 at 11:59 PM EDT.
            </p>
          </motion.div>

          {/* Countdown — compact, directly below the subtitle */}
          <motion.div
            ...
            {expired ? (
              <div className="inline-flex flex-col items-center gap-3 rounded-2xl bg-white/10 border border-white/20 px-8 py-6">
                <span className="inline-flex items-center gap-2 text-white font-medium font-[Manrope,sans-serif]">
                  <Clock className="w-5 h-5" /> This enrollment window has closed
                </span>
                <Link
                  to="/consultation"
              ...
              <div className="flex items-center justify-center gap-2 sm:gap-3">
                ...
                <span className="text-xl sm:text-2xl font-semibold text-blue-300 font-[Manrope,sans-serif] pb-5" aria-hidden="true">:</span>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
        ...
        <div className="mt-10 grid sm:grid-cols-3 gap-4 text-center">
          {[
            ...
            { icon: Clock, label: "Ends Friday at 11:59 PM", desc: "Pricing returns to standard after the deadline" },
          ].map((item) => (
